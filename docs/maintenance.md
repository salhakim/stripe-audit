...
| Cadence | Task |
|---|---|
| Weekly (automated) | Triage **Dependabot** PRs — npm, docker (stripe-mock pin), and GitHub Actions ecosystems. Merge safe minor/patch; coordinate `stripe` major re-pins by hand. |
